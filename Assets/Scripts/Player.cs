...
public class Player : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (speed > 0.5f)
        {
            tbr.Rotate(0, 0, turn_w * 360 * Time.deltaTime);
            tbl.Rotate(0, 0, turn_w * 360 * Time.deltaTime);
        }
        ...
        if (speed > 0.5f)
        {
            tfr.Rotate(0, 0, turn_w * 360 * Time.deltaTime);
            tfl.Rotate(0, 0, turn_w * 360 * Time.deltaTime);
        }
